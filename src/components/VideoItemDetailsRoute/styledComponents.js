...
export const SuccessViewLikeBtnEl = styled.button`
  display: flex;
  justify-content: center;
  color: ${props => (props.likeVal ? '#2563eb' : '#64748b')};
  align-items: center;
  margin: 10px;
  font-weight: bold;
  padding: 10px;
  ...
  outline: none;
`
export const SuccessViewdisLikeBtnEl = styled.button`
  display: flex;
  justify-content: center;
  ...
  padding: 10px;
`
export const SuccessViewSaveLikeBtnEl = styled.button`
  display: flex;
  justify-content: center;
...
export const SuccesViewHr = styled.hr`
  width: 100%;
`
export const SuccesViewProfileContainer = styled.div`
  display: flex;
  width: 100%;
  flex-direction: ${props => (props.name ? 'column' : 'row')};
  padding: 10px;
`

export const SuccesViewLogoAndSubsciberContainer = styled.div`
  display: flex;
